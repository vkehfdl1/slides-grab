...
This project uses a 3-stage skill workflow under `.gemini/skills/`:

| Stage | Skill | What it does |
|-------|-------|-------------|
| 1. Plan | `.gemini/skills/plan-skill/SKILL.md` | Create slide-outline.md, get user approval |
| 2. Design | `.gemini/skills/design-skill/SKILL.md` | Generate slide HTML files |
| 3. Export | `.gemini/skills/pptx-skill/SKILL.md` | Convert to PPTX/PDF |

Or use the integrated skill `.gemini/skills/presentation-skill/SKILL.md` to go through all stages end-to-end.
