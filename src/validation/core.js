...
import { SLIDE_PT, SLIDE_PX, PT_TO_PX as _PT_TO_PX } from '../slide-dimensions.js';

export const FRAME_PT = SLIDE_PT;
export const PT_TO_PX = _PT_TO_PX;
export const FRAME_PX = SLIDE_PX;
